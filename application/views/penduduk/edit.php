                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tempat_lahir" class="form-control <?= form_error('tempat_lahir') != null ? 'is-invalid' : ''; ?>" placeholder="Masukkan tempat lahir lengkap" id="" value="<?= $data['tempat_lahir'] ?>" required>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal_lahir" class="form-control <?= form_error('tanggal_lahir') != null ? 'is-invalid' : ''; ?>" placeholder="Masukkan tanggal lahir" id="tgl_lahir" value="<?= $data['tanggal_lahir'] ?>" required>
