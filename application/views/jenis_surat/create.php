        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body p-5">
                    <form action="<?=site_url('jenissurat/store')?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="">Jenis Surat</label>
                                    <input type="text" name="jenis_surat" class="form-control" placeholder="Masukkan Surat" id="">
